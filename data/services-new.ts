...
export const serviceCategories = [
  {
    ...
    icon: Globe,
    description: 'Professional website development and digital presence solutions',
    services: [
  ...
  },
  {
    ...
    icon: Users,
    description: 'Advanced CRM solutions for better customer management',
    services: [
      'Lead Management',
  ...
  },
  {
    ...
    icon: Settings,
    description: 'Comprehensive technical implementation and support',
    services: [
